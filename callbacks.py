...
# 2. Callback with Data Processing
...
# 3. Event-driven Programming (simulated)
...
# 4. Asynchronous Operations (simulated with callback)
...
# 5. Higher-Order Functions with Callbacks (map, filter)
